...
Feature: Check the kickstart course format features.
  ...
  Scenario: Check the format plugin template access.
    ...
    # And I click on ".use-template" "css_element" in the ".template-list .card-deck:has(> .card[data-templatename=\"Custom sections\"])" "css_element"
    And I click on ".use-template" "css_element" in the ".template-list .card-deck:nth-child(6) .card" "css_element"
    ...
    # And I click on ".use-template" "css_element" in the ".template-list .card-deck:has(> .card[data-templatename=\"Weekly sections\"])" "css_element"
    Then I click on ".use-template" "css_element" in the ".template-list .card-deck:nth-child(7) .card" "css_element"
    And I click on "Import" "button" in the ".modal" "css_element"
