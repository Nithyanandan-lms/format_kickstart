...
Feature: Check the kickstart course format features.
  ...
  Scenario: Check the format plugin template access.
    ...
    And I click on ".use-template" "button" in the ".template-list .card-deck" "css_element"
    ...
    And I click on ".use-template" "button" in the ".template-list .card-deck:nth-child(2)" "css_element"
    And I click on "Import" "button" in the ".modal" "css_element"
